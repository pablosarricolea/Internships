...
def unet(pretrained_weights = None, input_size = (256,256,3), dropout = 0.2, hn = 'he_normal', reducing_factor = 8, n_classes = 5):
    ...
    up7 = Conv2D(int(256/reducing_factor), 2, activation = 'relu', padding = 'same', kernel_initializer = hn)(UpSampling2D(size = (2,2))(conv6))
    ...
    up8 = Conv2D(int(128/reducing_factor), 2, activation = 'relu', padding = 'same', kernel_initializer = hn)(UpSampling2D(size = (2,2))(conv7))
    ...
    up9 = Conv2D(int(64/reducing_factor), 2, activation = 'relu', padding = 'same', kernel_initializer = hn)(UpSampling2D(size = (2,2))(conv8))
